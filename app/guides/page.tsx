      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-2 border-b border-slate-200">
        <div>
          <div className="flex items-center gap-2.5">
            <span className="w-3 h-3 rounded-full bg-[#0b63e5] animate-pulse" />
          ...
          return (
            ...
            >
              <div className="space-y-4">
                ...
                <h2 className="font-black text-lg sm:text-xl text-slate-900 group-hover:text-[#0b63e5] transition-colors leading-snug">
                  {g.title}
                </h2>
                ...
                <div className="pt-2 border-t border-slate-100">
                  ...
                  <div className="flex items-center gap-2 overflow-hidden">
                    {sampleProducts.map((p) => (
                      <div
                        key={p.id}
                        className="p-1 rounded-xl bg-slate-50 border border-slate-200/80 shrink-0 group-hover:scale-105 transition-transform duration-300"
                    ...
                    {g.parts.length > 4 && (
                      <div className="w-10 h-10 rounded-xl bg-slate-100 border border-slate-200/80 flex items-center justify-center text-[11px] font-bold text-slate-500 shrink-0">
                        +{g.parts.length - 4}
                      </div>
                    )}
                  </div>
              ...
              <div className="pt-4 border-t border-slate-100 flex items-end justify-between gap-2">
                ...
                <span className="px-3.5 py-2 rounded-xl bg-slate-900 group-hover:bg-[#0b63e5] text-white text-xs font-bold transition-colors shadow-2xs flex items-center gap-1.5 shrink-0">
                  <span>Lire</span>
